...
export const AppRoutes: RouteProps[] = [
  ...
  { path: "/store/certificate-publishing", component: React.lazy(() => import("~/Pages/Store/CertificatePublishings").then((x) => ({ default: x.List }))) },
  { path: "/store/certificate-publishing/:certificatePublishingID", component: React.lazy(() => import("~/Pages/Store/CertificatePublishings/CertificatePublishingDetailsPage").then((x) => ({ default: x.CertificatePublishingDetailsPage }))) },

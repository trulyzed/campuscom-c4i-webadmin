...
export function PaymentGatewayDetailsPage(props: RouteComponentProps<{ paymentGatewayID?: string }>) {
  ...
  return <DetailsPage breadcrumbDataIndex="name" getMeta={getPaymentGatewayDetailsMeta} getDetailsPageContent={PaymentGatewayQueries.getSingle} entityType="paymentGateway" entityID={PaymentGatewayID} titleKey="transaction_request_id" />
}
...
export function PaymentGatewayConfigDetailsPage(props: RouteComponentProps<{ paymentGatewayConfigID?: string }>) {
  ...
  return <DetailsPage getMeta={getPaymentGatewayConfigDetailsMeta} getDetailsPageContent={PaymentGatewayConfigQueries.getSingle} entityType="paymentGatewayConfig" entityID={PaymentGatewayConfigID} titleKey="transaction_request_id" />
}
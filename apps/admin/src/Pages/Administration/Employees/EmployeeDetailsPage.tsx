...
export function EmployeeDetailsPage(props: RouteComponentProps<{ employeeID?: string }>) {
  ...
  return <DetailsPage breadcrumbDataIndex="name" getMeta={getEmployeeDetailsMeta} getDetailsPageContent={EmployeeQueries.getSingle} entityType="employee" entityID={EmployeeID} />
}
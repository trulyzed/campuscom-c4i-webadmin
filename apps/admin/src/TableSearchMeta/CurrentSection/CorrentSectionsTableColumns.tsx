...
export const getCorrentSectionsTableColumns = (isModal = false): ITableMeta => {
  const columns: TableColumnType = [
    {
      render: (text: any, record: any) => renderDetailsLink(`/current-sections/${record.SectionID}`)
    },
    {
      title: "Name",
  ...
  return { columns, searchFunc: findFacultySections, tableName: "CorrentSectionsTableColumns" }
}

...
export const getCertificateListTableColumns = (isModal = false, CertificateID?: number): ITableMeta => {
  const columns: TableColumnType = [
    {
      title: "Title",
      dataIndex: "title",
      render: (text: any, record: any) => renderLink(`/course-provider/certificate/${record.id}`, text, isModal),
  ...
  return {
    columns,
    searchFunc: CertificateQueries.getPaginatedList,

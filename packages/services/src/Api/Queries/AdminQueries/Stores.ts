...
export const StoreQueries: IStoreQueries = {
  ...
  getListByCoursePublishing: PermissionWrapper(
    (data) => {
      return adminApi({
  ...
  updateWithoutSlug: PermissionWrapper(
    (data) => {
      const payload = convertToFormData({
        ...data?.data,
        store_logo_uri: data?.data.image_file?.length ? data?.data.image_file : undefined
  ...
  tagIdentityProvider: PermissionWrapper(
    (data) => {
      const payload = {
        ...data?.data,
  ...
  untagIdentityProvider: PermissionWrapper(
    (data) => {
      return adminApi({
  ...
  tagPaymentGateway: PermissionWrapper(
    (data) => {
      return adminApi({
  ...
  untagPaymentGateway: PermissionWrapper(
    (data) => {
      return adminApi({
  ...
  tagConfiguration: PermissionWrapper(
    (data) => {
      return adminApi({
  ...
  updateConfiguration: PermissionWrapper(
    (data) => {
      const { id, ...params } = data?.params
      return adminApi({
  ...
  tagPaymentQuestion: PermissionWrapper(
    (data) => {
      const payload = {
        ...data?.data,

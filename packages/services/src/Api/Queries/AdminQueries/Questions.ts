...
export const QuestionQueries: IQuestionQueries = {
  ...
  getListByCourseProvider: PermissionWrapper(
    (data) => {
      const { pagination, ...nonPaginationParams } = data?.params || {}
      return adminApi({
  ...
  getPaymentQuestionListByStore: PermissionWrapper(
    (data) => {
      const { pagination, ...nonPaginationParams } = data?.params || {}
      return adminApi({
  ...
  getRegistrationQuestionListByCourse: PermissionWrapper(
    (data) => {
      const { pagination, ...nonPaginationParams } = data?.params || {}
      return adminApi({
  ...
  untagPaymentQuestion: PermissionWrapper(
    (data) => {
      return adminApi({

...
const renderCopyToClipboard = (content: any, options: { successMessage?: string; title?: string; } | undefined) => <CopyToClipboard content={content} title={options?.title} successMessage={options?.successMessage} />
